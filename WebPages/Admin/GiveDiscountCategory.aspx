<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Admin2.Master" AutoEventWireup="true" CodeBehind="GiveDiscountCategory.aspx.cs" Inherits="_211792H.WebPages.Admin.GiveDiscountCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body>
        ...
        <form action="#">
          <fieldset>
            <legend>Give Discount to categories</legend>
            <br />
            <p>Selected items</p>
        ...
        <script type="text/javascript">
            ...
            function validatedate(sender , args) {
                ...
                console.log(inputfirst2)
                console.log(inputmiddle2)
                console.log(inputlast2)
